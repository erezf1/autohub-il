  ...
  return (
    <MobileLayout>
      <div className="flex-1 p-4 space-y-4" dir="rtl">
        <h1 className="text-xl font-bold mb-4">רכבים חמים</h1>
        {/* Header Info */}
        <div className="bg-gradient-to-l from-orange-500 to-red-500 rounded-lg p-4 text-white">
          ...
          <p className="text-sm opacity-90">
            רכבים עם בוסט מוצגים בראש התוצאות למשך 3 ימים
          </p>
        </div>
        ...
        <Card className="p-4 border-orange-200 bg-orange-50">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-medium">הבוסטים שלי</h3>
              <p className="text-sm text-muted-foreground">5 בוסטים זמינים</p>
            </div>
            <Button 
              size="sm" 
